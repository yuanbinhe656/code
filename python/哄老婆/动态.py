...
IMAGE_ENLARGE = 12  # 在这里改 放大比例 画布放大后，心太小？把这个改大点
HEART_COLOR = "#ff1a1a"  # 心的颜色 在这里改

WINDOWS_TITLE = '小冠冠~'  # 窗口标题 在这里改
HEART_CENTER_TEXT = '最爱小冠冠了'  # 中间文字内容 在这里改
HEART_CENTER_TEXT_COLOR = '#ff4d94'  # 中间文字颜色 在这里改
