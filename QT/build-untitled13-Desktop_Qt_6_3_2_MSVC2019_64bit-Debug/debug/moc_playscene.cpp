...
#include <memory>
#include "../../untitled13/playscene.h"
...
static const qt_meta_stringdata_Playscene_t qt_meta_stringdata_Playscene = {
    {
        ...
        QT_MOC_LITERAL(10, 16),  // "selectLevelScene"
        QT_MOC_LITERAL(27, 0)   // ""
    },
    "Playscene",
    "selectLevelScene",
...
void Playscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->selectLevelScene(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Playscene::selectLevelScene; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Playscene, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void Playscene::selectLevelScene()
{
