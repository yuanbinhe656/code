...
#include <memory>
#include "../../untitled13/chooselevelscene.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_chooselevelscene_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_chooselevelscene_t qt_meta_stringdata_chooselevelscene = {
    {
        ...
        QT_MOC_LITERAL(17, 15),  // "chooseBackScene"
        QT_MOC_LITERAL(33, 0)   // ""
    },
    "chooselevelscene",
    "chooseBackScene",
...
void chooselevelscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->chooseBackScene(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &chooselevelscene::chooseBackScene; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject chooselevelscene::staticMetaObject = { {
    ...
    qt_meta_stringdata_chooselevelscene.offsetsAndSizes,
    qt_meta_data_chooselevelscene,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_chooselevelscene_t
, QtPrivate::TypeAndForceComplete<chooselevelscene, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
