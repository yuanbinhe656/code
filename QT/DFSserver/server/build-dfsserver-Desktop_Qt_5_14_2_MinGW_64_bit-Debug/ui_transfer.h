...
public:
    ...
    void setupUi(QWidget *Transfer)
    {
        ...
        Transfer->resize(745, 550);
        tabWidget = new QTabWidget(Transfer);
        tabWidget->setObjectName(QString::fromUtf8("tabWidget"));
        tabWidget->setGeometry(QRect(0, 0, 745, 550));
        QFont font;
        ...
        upload_scroll->setGeometry(QRect(0, 0, 737, 508));
        ...
        download_scroll->setGeometry(QRect(0, 0, 737, 508));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 737, 508));
