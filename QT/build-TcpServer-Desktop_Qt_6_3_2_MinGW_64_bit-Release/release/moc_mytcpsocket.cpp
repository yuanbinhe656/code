...
#include <memory>
#include "../../cloud file/TcpServer/mytcpsocket.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_mytcpsocket_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject mytcpsocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_mytcpsocket.offsetsAndSizes,
